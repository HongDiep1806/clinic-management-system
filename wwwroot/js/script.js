...
$(document).on('click', '.toggle-password', function () {
  ...
  $(document).ready(function () {
    ...
    $(document)
      .off("click", ".add-diagnosis")
      .on("click", ".add-diagnosis", function (e) {
        e.preventDefault();
    ...
    $(document)
      .off("click", ".remove-diagnosis")
      .on("click", ".remove-diagnosis", function (e) {
        e.preventDefault();
  ...
  $(document).ready(function () {
    // Ensure no duplicate bindings
    $(document)
      .off("click", ".add-reminder")
      .on("click", ".add-reminder", function (e) {
        e.preventDefault();
    ...
    // Remove a diagnosis input row
    $(document)
      .off("click", ".remove-reminder")
      .on("click", ".remove-reminder", function (e) {
        e.preventDefault();
  ...
  // Sidebar submenu toggle fix for Vue
...
// Vue fix: reinitialize datetimepicker after Vue renders
document.addEventListener("DOMContentLoaded", function() {
  setTimeout(function() {
    if ($(".datepic").length > 0) {
      $(".datepic").datetimepicker({
